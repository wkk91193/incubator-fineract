...
public class GlAccountSheetPopulator extends AbstractWorkbookPopulator {
	...
	//private List<GLAccountData> filteredglAccounts;
	...
	public void populate(Workbook workbook) {
		...
		//filterGLAccounts();
		//System.out.println("Filtered GL accounts "+filteredglAccounts.size());
...
//	private void filterGLAccounts() {
//		filteredglAccounts = new ArrayList<>();
//		for (GLAccountData glAccountData : filteredglAccounts) {
//			if (glAccountData.getUsage().getValue().equals("DETAIL")) {
//				filteredglAccounts.add(glAccountData);
//			}
//		}
//	}

	private void populateglAccounts(Sheet GlAccountSheet, int rowIndex) {
		//for (GLAccountData glAccount : filteredglAccounts) {
